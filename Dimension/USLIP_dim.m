...
function [nstep,y_tot,t_event,xt_tot,y_event,epsilon,conv]=USLIP_dim(Pin,Cin,IC,epsilon)

%function descrpition goes here: ... %

% ---------------------- Variables extraction and initialization ---------
% global variables
global m M k rhow g V r0 drmax Ax Ay cdx cdy rs alfa r
...
maxstep=length(epsilon);  
    ...
    for nstep=1:maxstep
        ...
        [T2,Y2,TE2,YE2,IE2]=ode113(@PuntPhaseDim,tspan2,YE,options,epsilon(nstep));
